 ...
 * Gulpfile.
 *
 * Gulp with WordPress Underscores (Sassified).
 *
 * Implements:
 ...
 *
 * @author Brian Douglas (@bmdinteractive)
 * @version 1.0.3
 */
...
// Project related.
var project                 = 'ThemeName'; // Theme Name.
var projectURL              = 'eveblackwater.dev'; // Theme URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'theme-name'; // Your textdomain here.
var destFile                = 'theme-name.pot'; // Name of the transalation file.
var packageName             = 'theme-name'; // Package name.
var bugReport               = 'https://yoursite.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'Your Name <your_email@email.com>'; // Last translator Email ID.
...
// Watch files paths.
var styleWatchFiles         = './sass/css/**/*.scss'; // Path to all *.scss files inside css folder and inside them.
